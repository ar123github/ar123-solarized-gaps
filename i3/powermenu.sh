...
Go to file
￼
jluttine Fix #2 by making XDG_SESSION_ID optional
Latest commit 368ba43 on 30 Jan
 History
 1 contributor
Executable File  246 lines (228 sloc)  7.92 KB
RawBlame
...
while true; do
    case "$1" in
        "-h"|"--help")
            ...
            echo "                     recommended to combine this option with --confirm=CHOIC"
